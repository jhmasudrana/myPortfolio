    ...
    return (
        <div id='home'>
            <header className='flex items-center justify-between py-5 px-5 md:px-0' data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0">
                <h1 className='md:text-4xl text-2xl font-extrabold uppercase text-transparent bg-clip-text bg-gradient-to-br from-[#ee00ff] to-[#00ffc3] via-[#bf2eec] hover:via-[#00ffd5] dark:via-[#00ffd5]  hover:from-[#c800ff] hover:to-[#bf2eec]'>MD MASUD RANA</h1>
                <div className='flex items-center gap-4'>
                    <a href="" download type="button" className="">
            ...
            <section className='flex justify-between md:my-20 my-10 items-center flex-col-reverse md:flex-row'>
                <div className='md:w-1/2 mx-10 md:mx-0 py-10 md:py-0' data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0">
                    <h1 className={`md:text-6xl font-semibold text-white text-3xl`}>MASUD RANA</h1>
                    ...
                    <div className='flex gap-3 md:gap-5 py-6'>
                        <a target='_blank' href="https://www.facebook.com/profile.php?id=100078116664025&mibextid=kFxxJD"><FaFacebook className='md:text-2xl text-xl hover:scale-125 text-white hover:text-[#DC0DFE] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></a>
                        <a target='_blank' href="https://github.com/"><FaGithub className='md:text-2xl text-xl hover:scale-125 text-white hover:text-[#DC0DFE] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></a>
                ...
                <div className="avatar md:w-[350px] w-[250px]" data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="bottom-bottom">
                    <div className="mask mask-squircle">
                        <img src="https://i.ibb.co.com/yVXzj8r/protfolio.jpg" />
                    </div>
                </div>
            </section>
        </div>
